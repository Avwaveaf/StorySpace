...
import com.avwaveaf.storyspace.databinding.ActivityCameraBinding
import com.avwaveaf.storyspace.helper.createCustomTempFile
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            try {
                ...
                Toast.makeText(
                    this@CameraActivity,
                    "Failed to show camera: ${exc.message}",
                    Toast.LENGTH_SHORT
                ).show()
